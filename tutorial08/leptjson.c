...
int lept_is_equal(const lept_value *lhs, const lept_value *rhs)
{
    ...
    case LEPT_OBJECT:
        ...
        {
            size_t pos;
            if ((pos = lept_find_object_index(rhs, lhs->u.o.m[i].k, lhs->u.o.m[i].klen)) == LEPT_KEY_NOT_EXIST)
                return 0;
            if (!lept_is_equal(&lhs->u.o.m[i].v, &rhs->u.o.m[pos].v))
                return 0;
        }
        return 1;
    default:
...
lept_value *lept_set_object_value(lept_value *v, const char *key, size_t klen)
{
    ...
    memcpy(v->u.o.m[index].k = (char *)malloc(klen + 1), key, klen + 1);
...
void lept_remove_object_value(lept_value *v, size_t index)
{
    ...
    v->u.o.m[index].k = v->u.o.m[v->u.o.size - 1].k;
