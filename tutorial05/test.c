...
static void test_parse_array()
{
    ...
    /* Test case:[ null , false , true , 123 , "abc" ] */
    lept_init(&v);
    ...
    for (i = 0; i < 1; ++i)
    {
        EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(lept_get_array_element(lept_get_array_element(&v, 1), i)));
        EXPECT_EQ_DOUBLE((double)i, lept_get_number(lept_get_array_element(lept_get_array_element(&v, 1), i)));
    }
    /* element 2 */
    ...
    for (i = 0; i < 2; ++i)
    {
        EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(lept_get_array_element(lept_get_array_element(&v, 2), i)));
        EXPECT_EQ_DOUBLE((double)i, lept_get_number(lept_get_array_element(lept_get_array_element(&v, 2), i)));
    }
    /* element 3 */
    ...
    for (i = 0; i < 2; ++i)
    {
        EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(lept_get_array_element(lept_get_array_element(&v, 3), i)));
        EXPECT_EQ_DOUBLE((double)i, lept_get_number(lept_get_array_element(lept_get_array_element(&v, 3), i)));
    }
